...
letters = {
    'h', 'x', 'r', 'f', 'u', 'g', 'o', 't', 'v', 'e', 's', 'w', 'i', 'n'
}


def add_number(str_slice: str, numbers: list) -> None:
    n = DIGIT_MAP.get(str_slice)
    if n:
        numbers.append(n)
    ...
    for line in lines.split():
        ...
        for index, symbol in enumerate(line):
            if symbol.isnumeric():
                ...
                add_number(line[index:index + 3], numbers)
                add_number(line[index:index + 4], numbers)
                add_number(line[index:index + 5], numbers)
